...
<!--Потрібно саме тут, а не в js/admin.js чомусь-->
...
<script>
    ...
    //Date
    //Datemask dd/mm/yyyy
    $('#datemask').inputmask('dd/mm/yy', { 'placeholder': 'dd/mm/yy' })
    //Datemask2 mm/dd/yyyy
    $('#datemask2').inputmask('dd/mm/yy', { 'placeholder': 'dd/mm/yy' })
    //Money Euro
    $('[data-mask]').inputmask()

    //Date picker
    $('#reservationdate').datetimepicker({
        /*формат для відмови від сетера, але з корявим некрасивим форматом 2014/05/20*/
        /*format: 'YYYY/MM/DD'*/
        format: 'DD/MM/YYYY'
