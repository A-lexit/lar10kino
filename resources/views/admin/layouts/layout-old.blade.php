            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('original_titles.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Список оригінальних назв</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('original_titles.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Додати оригінальну назву</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('watches.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Статуси перегляду</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('watches.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Новий статус перегляду</p>
                                </a>
                            </li>
                        </ul>
                    </li>
...
<script src="{{ asset('assets/admin/ckeditor5/build/ckeditor.js') }}"></script>                {{--14--}}
<script src="{{ asset('assets/admin/ckfinder/ckfinder.js') }}"></script>                       {{--14--}}

<script>                                                                                        {{--14--}}
    ClassicEditor                                                                               {{--14 створення--}}
