                            ...
                            @if($film->genres->count())
                                <div class="tag-cloud-single">
                                    ...
                                    <td>@foreach($film->genres as $genre)
                                            <small><a href="{{ route('genres.single', ['slug'=>$genre->slug]) }}" title="">{{$genre->title}}@if (!$loop->last),@endif</a> </small>
                                        @endforeach</td>
                                </div>
                            @endif
                        </div></tr>
...
<!--                                <td class="first-col-film"><span>Тривалість в хв:</span></td>-->
@if($film->duration_id  < 60)
                                    {{--                                    <td><small><p>{{$filmdurmunut}}хв </p> </small></td>--}}
                                    <td><small><p>{{$film->getDurationMinutes()}}хв</p> </small></td>
    @else
        {{--<td><small><p>{{$filmduri}}год {{$filmdurmunut}}хв </p> </small></td>--}}
                                    <td><small><p>{{$film->getDurationHours()}}год {{$film->getDurationMinutes()}}хв</p> </small></td>
                            ...
                            @if($film->countries->count())
                                <div class="tag-cloud-single">
                                    ...
                                    <td>@foreach($film->countries as $country)
                                            <small><a href="{{ route('countries.single', ['slug'=>$country->slug]) }}" title="">{{$country->title}}@if (!$loop->last),@endif</a> </small>
                                        @endforeach</td>
                                </div>
                            @endif
                        </div></tr>
                            ...
                            @if($film->companies->count())
                                <div class="tag-cloud-single">
                                    ...
                                    <td>@foreach($film->companies as $company)
                                            <small><a href="{{ route('companies.single', ['slug'=>$company->slug]) }}" title="">{{$company->title}}@if (!$loop->last),@endif</a> </small>
                                        @endforeach</td>
                                </div>
                            @endif
                        </div></tr>
                            ...
                            @if($film->producers->count())
                                <div class="tag-cloud-single">
                                    ...
                                    <td>@foreach($film->producers as $producer)
                                            <small><a href="{{ route('producers.single', ['slug'=>$producer->slug]) }}" title="">{{$producer->name}}@if (!$loop->last),@endif</a> </small>
                                        @endforeach</td>
                                </div>
                            @endif
                        </div></tr>
                            ...
                            @if($film->directors->count())
                                <div class="tag-cloud-single">
                                    ...
                                    <td>@foreach($film->directors as $director)
                                            <small><a href="{{ route('directors.single', ['slug'=>$director->slug]) }}" title="">{{ $director->name }}@if (!$loop->last),@endif</a> </small>
                    ...
                    <tr><div class="blog-title-area">
                            ...
                            <div class="tag-cloud-single">
                                ...
                                <td>@foreach($film->composers as $composer)
                                        <small><a href="{{ route('composers.single', ['slug'=>$composer->slug]) }}" title="">{{$composer->name}}@if (!$loop->last),@endif</a> </small>
                            ...
                            <div class="tag-cloud-single">
                                ...
                                <td>
                                    ...
                                    @foreach($film->actors as $actor)
                                            ...
                                            <small><a href="{{ route('actors.single', ['slug'=>$actor->slug]) }}" title="">{{$actor->name}}@if (!$loop->last),@endif</a> </small>
...
<div class="nnn">
                        @foreach($film->moreFilmsLimit() as $filmm)
